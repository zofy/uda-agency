...
def get_actor(payload, actor_id: int):
    ...
    if not actor:
        ...
        flask.abort(404)
    return flask.jsonify({"success": True, "actor": actor.format()})
...
def create_actor(payload):
    ...
    try:
        ...
        return flask.jsonify({"success": True, "created_id": actor.id})
...
def delete_actor(payload, actor_id: int):
    ...
    try:
        ...
        return flask.jsonify({"success": True, "deleted_id": actor_id})
...
def update_actor(payload, actor_id: int):
    ...
    try:
        ...
        return flask.jsonify({"success": True, "updated_id": actor.id})
